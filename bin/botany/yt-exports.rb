...
catalogs = ["CAN 84040", "CAN 530291", "CAN 536225", "CAN 394505", "CAN 529134", "CAN 522842", "CAN 522843", "CAN 511684", "CAN 511694", "CAN 83951", "CAN 450363", "CAN 302732", "CAN 538589", "CAN 457900", "CAN 537861", "CAN 394423", "CAN 233503", "CAN 83922", "CAN 402097", "CAN 394422", "CAN 223007", "CAN 83948", "CAN 467604", "CAN 264750", "CAN 83949", "CAN 83957", "CAN 83954", "CAN 389258", "CAN 375254", "CAN 333207", "CAN 467606", "CAN 374967", "CAN 364857"]

CSV.open(output_dir(__FILE__) + "/Myriophyllum_still_on_loan.csv", 'w') do |csv|
  csv << [
    "id_number",
    "label_name",
    "taxon_link",
...
Parallel.map(catalogs.in_groups_of(40, false), progress: "Catalogs", in_processes: 8) do |group|
  CSV.open(output_dir(__FILE__) + "/Myriophyllum_still_on_loan.csv", 'a') do |csv|
    group.each do |id|
