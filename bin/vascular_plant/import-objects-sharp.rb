...
file = "/Users/dshorthouse/Desktop/Object upload_MT_2019_Crataegus loan.txt"
log = "/Users/dshorthouse/Desktop/Object upload_MT_2019_Crataegus loan-log.csv"
...
CSV.foreach(file, :headers => true, :col_sep => "\t", :encoding => 'bom|utf-16le:utf-8') do |row|
  ...
  if new_record
    ...
    #Add to existing Group (id = 4547, "MT-Crataegus loan 2019")
    group_member = GroupMember.new
    group_member.group_id = 4820
    group_member.table_key = obj.id
    group_member.save
