class Valuation < ActiveRecord::Base
  ...
  ignore_columns :step, :record_view, :currency, :exchange_value, 
    :exchange_rate, :exchange_currency, :last_valuation, :last_currency, 
    :next_valuation_date, :option1, :option2, :number1, :number2, 
    :date1, :date2
