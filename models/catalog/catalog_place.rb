class CatalogPlace < ActiveRecord::Base
  ...
  ignore_columns :step, :record_view, :specific_locale, :habitat, :affiliation, :begin_date, :end_date, :portion, :position, :attrib_type, :attributor, :attrib_date, :attrib_source, :certainty, :attrib_comment, :note, :option1, :option2, :option3, :option4, :unlinked_value, :placevarkey
