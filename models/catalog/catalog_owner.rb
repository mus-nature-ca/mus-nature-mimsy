class CatalogOwner < ActiveRecord::Base
  ...
  ignore_columns :step, :record_view, :how_acquired, 
    :disposal_method, :relationship, :affiliation, 
    :portion, :position, :attrib_type, :attributor, 
    :attrib_date, :attrib_source, :certainty, 
    :attrib_comment, :note, :option1, :option2, 
    :option3, :option4, :unlinked_value, :nvarkey
