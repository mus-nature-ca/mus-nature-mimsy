class MadeDate < ActiveRecord::Base
  ...
  ignore_columns :step, :record_view, :date_type, 
    :earliest_monthday, :latest_monthday, :century, 
    :period_era, :year_dated, :age, :relationship, 
    :attrib_type, :attributor, :attrib_date, 
    :attrib_comment, :attrib_source, :certainty, 
    :dating_method, :note, :context_identifier, 
    :context, :stratigraphic_type, :stratigraphic_unit
