class ExhibitionCatalog < ActiveRecord::Base
  ...
  ignore_columns :step, :record_view, :theme_sub4, :theme_sub5, :theme_sub6, :level1, :level2, :level3, :level4, :level5, :level6, :container, :arrangement, :catalogue_number, :note, :option1, :option2, :option3, :option4, :number1, :number2, :date1, :date2
