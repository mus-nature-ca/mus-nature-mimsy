class AcquisitionCatalog < ActiveRecord::Base
  ...
  ignore_columns :step, :record_view, :lotkey, :lot_id, :assessment, :assessed_by, :offer_price, :price, :price_currency, :price_exchange_rate, :price_rate_date, :initial_value, :value_currency, :repro_order_number, :return_to, :option1, :option2, :number1, :number2, :date1, :date2
